...
public:
    explicit Student(int _id, const std::string &_name, const std::string &_surname, int _age,
                     const std::string &description = "")
            : _id(_id), _name(_name), _surname(_surname), _age(_age), _description(description) {}
